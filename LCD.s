...
global  LCD_Setup, LCD_Write_Message, LCD_Clear, LCD_delay_x4us, LCD_delay_ms, LCD_Line2, LCD_Send_Byte_D, LCD_Cursor_Off, LCD_Cursor_On, LCD_Write_Hex, counter_cursor
...
;	movwf	LCD_cnt_l, A	; now need to multiply by 4 for PLLCFG = ON 
;	bcf	CARRY
;	clrf	LCD_cnt_h, A
;	rlcf	LCD_cnt_l, F, A
;	rlcf	LCD_cnt_h, F, A
...
LCD_Clear:
	movlw	00000001B	; LCD clear screen instruction
	call	LCD_Send_Byte_I
	movlw	2		; wait 2ms
	call	LCD_delay_ms
	return 
